...
* Линтер: ESLint + plugins
* Тестер: Jest + plugins

- 'npm run build' - Запуск сборки проекта.
- 'npm run prebuild' - Запуск сборки проекта для развертывания на http://localhost:8080.
...
- 'npm run deploy' - Публикация каталога dist на GitHub Pages.
